...
int gamma_table_low_light[][2] = {
    {0,0},{64,153},{128,339},{256,780},{384,1296},{512,1842},{640,2388},{768,2918},
    {896,3384},{1024,3802},{1280,4511},{1536,5144},{1792,5699},{2048,6204},{2304,6677},{2560,7125},
    {2816,7566},{3072,7978},{3584,8694},{4096,9327},{4608,9894},{5120,10388},{6144,11218},{7168,11915},
    {8192,12564},{9216,13157},{10240,13680},{11264,14163},{12288,14576},{13312,14981},{14336,15391},{16384,16275},
};
...
int main(int arg, char **argv) {
    ...
    for (int i = 0; i < 31; i++) {
        int x1 = gamma_table_albert_outdoor[i][0];
        int y1 = gamma_table_albert_outdoor[i][1];
        int x2 = gamma_table_albert_outdoor[i+1][0];
        int y2 = gamma_table_albert_outdoor[i+1][1];
        double a = (y2 -y1) / (double)(x2 - x1);
        double b =  y1 - a * x1;
        cout << a << "," << b << endl;
